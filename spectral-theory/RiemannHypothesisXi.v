...
(*                                                                    *)
(*  What IS proved in the repo, unconditionally, is only the far       *)
(*  weaker right-edge nonvanishing (CEulerProductZeta.zetaC_nonzero:    *)
(*  zetaC <> 0 for Re > 1) and, conditional on two classical analytic  *)
(*  lemmas, the strip confinement (ZetaStripConfinement.XiC_zeros_in_  *)
(*  strip).  RH itself — the collapse of the strip onto the line —      *)
(*  is untouched.                                                      *)
(* ================================================================= *)
