...
(*                                                                    *)
(*    first_zero_exists :                                              *)
(*      exists t, 10 < t < 16 /\ XiC (crit t) = C0                     *)
...
(*                                                                    *)
(*  It costs nothing: the two sign changes are proved in FirstZeroT10  *)
...
Require Import ComplexField RiemannXiEntire CoherenceSingularity CritLineZeroCollapse
        EtaZetaStripC FirstZeroT10 FirstZeroT16.
...
Theorem first_zero_exists :
  exists t, 10 < t < 16
         ...
         /\ ccollapses (ceta_partial (crit t)).
Proof.
  assert (Hsign : xir 10 * xir 16 < 0).
  { pose proof xir_10_pos. pose proof xir_16_neg. nra. }
  destruct (crit_sign_change_gives_zero_collapse 10 16 ltac:(lra) Hsign)
    as [t [Ht [HX [_ HC]]]].
