...
(*  integral formula.                                                  *)
(*                                                                    *)
(*  SUPERSEDED -- READ THIS FIRST: the off-centre-pole winding IS now  *)
(*  proved, in CWindingOffCenter.v (winding_interior), by route (ii)   *)
(*  below (parameter differentiation, via CLeibniz.leibniz_deriv).     *)
(*  The paragraph that follows is the ORIGINAL scoping note and is     *)
(*  stale; do not cite it as an open problem.                          *)
(*                                                                    *)
(*  [stale] NOT proved here: the genuinely off-centre-POLE winding     *)
