(* ================================================================= *)
(*                                                                    *)
(*  LARGELY REDUNDANT.  VonMangoldtGlobal.vonmangoldt_identity already *)
(*  proves dsum Lam n = ln (INR n) (dsum Lam n IS Rls (divisors n) Lam),*)
(*  and CVonMangoldtSeries.Lam_le_ln already proves Lam n <= ln n, for  *)
(*  VonMangoldtGlobal's Lam.  I did not check before writing this.      *)
(*  What is here is the same identity for a DIFFERENT avatar of Lambda  *)
(*  (ln of DirichletVonMangoldt.vexp rather than ln of spf on prime     *)
(*  powers) and in RS-with-indicator form.  Nothing downstream uses it: *)
(*  build against VonMangoldtGlobal.Lam instead.                        *)
