...
(*  Its INVERSE LIMIT lim_n Chain n is the ring of p-adic integers      *)
(*  Z_p (the domain of Padic.v); its DIRECT limit (with inclusions) is  *)
(*  the full chain N.  Both limits are INFINITE -- that is exactly the  *)
(*  boundary where the family stops being finite.                      *)
(*                                                                    *)
...
(*  topologies; the inverse limit (Z_p, Padic) is where it goes infinite.*)
