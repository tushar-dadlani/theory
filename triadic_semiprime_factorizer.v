  ...
  - simpl.
    ...
    + destruct (divides d n) eqn:Hdiv.
      * split. omega.
        ...
        apply Nat.div_exact. omega. exact Hdiv.
      * apply IHf. omega. exact Hn.
    + split. omega.
      apply Nat.div_exact. omega.
      apply Nat.mod_same. omega.
Qed.
  ...
  - simpl.
    ...
    + destruct (divides d n) eqn:Hdiv.
      * apply Nat.leb_le in Hdd.
        ...
        -- apply Nat.le_mul_r. omega.
        -- exact Hdd.
      * apply IHf. omega. exact Hn. omega.
    + omega.
Qed.
...
Proof. apply triadic_factor_correct. omega. Qed.
...
Proof.
  ...
  { unfold factor in Hf.
    ...
    rewrite <- Hp, <- Hq.
    apply smallest_divisor_divides. omega. }
  split.
